...
class StandardScoreMechanism(
    ...
    override fun computeGameScore(): String {
        ...
        return when {
            setScoreDifference ==  0 && playerA.gameScore >= 3 -> "Deuce"
            setScoreDifference == -1 && playerA.gameScore >= 3 -> "Advantage ${playerB.name}"
            setScoreDifference ==  1 && playerA.gameScore >= 3 -> "Advantage ${playerA.name}"
